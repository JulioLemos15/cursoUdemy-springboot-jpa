...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2);// Assosiação entre os objetos
		...
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5)); //para salvar novamente os produtos com as associações
